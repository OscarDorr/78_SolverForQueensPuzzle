...
public class BoardForQueensPuzzle {
    ...
    public BoardForQueensPuzzle( BoardForQueensPuzzle old) {
        ...
        filesWithQueens = new int[old.ranks()];//creates a new instance of an integer array
        for(int counter = 0; counter < old.filesWithQueens.length; counter++){//populates array with elements of old's filesWithQueens
          filesWithQueens[counter] = old.filesWithQueens[counter];
        }
    }
