...
## Oscar's remarks
Code works as intended, be wary of running it on a problem size
of anything above 11, especially on a 2008 MacBook Pro
### citations / worked with / received help from
##Basic Help:
* Used information from in class discussions and group work to come up with my population
* Heavily altered my plan based on Piazza thread 479

##Personal Help:
* Consulted with classmates Adam Cohen and Kyra Gunluk to help clear up misunderstandings about the copy constructor
and the recordSolutionsStarted method. Did not look at anyone's finished code but shared bits and pieces of our in progress
copy constructors with each other.
* Took advice but no actual code from discussions in the Facebook group chat with all members of the classmates
* Most notably I learned a way of NTTSTT from Jason Wu
